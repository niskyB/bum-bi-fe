...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Main Colors
    const primary = [
      "bg-[#FD4D5F] border-[#FD4D5F] text-white dark:border-[#FD4D5F] ", // Default
      "[&:hover:not(:disabled)]:bg-[#FD4D5F]-100 [&:hover:not(:disabled)]:border-slate-100", // On hover and not disabled
    ...
    const secondary = [
      "bg-white/70 border-white/70 text-slate-500", // Default
    ...
    const outlinePrimary = [
      ...
      "dark:border-secondary", // Dark mode
    ...
    return (
      <button
        ...
        className={twMerge([
          ...
          variant == "outline-success" && outlineDanger,
